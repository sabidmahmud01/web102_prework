...
const displayStr = `A total of $${totalRaisedAll.toLocaleString('en-US')} has been raised for ${totalGames} ${totalGames === 1 ? "game" : "games"}. Currently, ${numUnfunded} ${numUnfunded === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
